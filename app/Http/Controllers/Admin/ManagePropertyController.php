...
class ManagePropertyController extends Controller
{
    ...
    public function propertyStore(Request $request, $language = null)
    {
        ...
        $rules = [
            ...
            'total_investment_amount' => 'nullable',
        ...
        try {
            ...
            $manageProperty->total_investment_amount = null;
            $manageProperty->available_funding = null;
            ...
            $manageProperty->is_available_funding = 0;
            $manageProperty->start_date = null;
            $manageProperty->expire_date = null;
