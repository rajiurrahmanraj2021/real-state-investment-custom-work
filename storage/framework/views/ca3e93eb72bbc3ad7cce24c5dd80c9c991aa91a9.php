...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <?php $__currentLoopData = $allAmenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($amenity->id); ?>" <?php if($singlePropertyDetails[$language->id][0]->manageProperty->amenity_id): ?> <?php echo e(in_array($amenity->id, $singlePropertyDetails[$language->id][0]->manageProperty->amenity_id) ? 'selected' : ''); ?> <?php endif; ?> ><?php echo app('translator')->get(optional($amenity->details)->title); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-3 col-xl-3 d-none">
                                                <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\chaincity_custom\cc\resources\views/admin/property/edit.blade.php ENDPATH**/ ?>