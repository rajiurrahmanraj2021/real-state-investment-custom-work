            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="list-group withdraw-detail">
                        ...
                        <li class="list-group-item">
                            <span class="font-weight-bold "> <?php echo app('translator')->get('Total Investment Amount'); ?>: </span>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\chaincity_custom\cc\resources\views/admin/property/list.blade.php ENDPATH**/ ?>