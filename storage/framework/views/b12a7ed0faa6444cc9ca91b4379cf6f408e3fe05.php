        ...
        <form action="" method="post" id="invest-form" class="login-form invest_now_modal">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel"><?php echo app('translator')->get('Invest Now'); ?></h5>
                ...
                <div
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <button type="submit" class="btn-custom"><?php echo app('translator')->get('Invest'); ?></button>
                    <?php else: ?>
...
<?php /**PATH D:\xammp\htdocs\chaincity_custom\chaincity_custom\resources\views/themes/original/partials/investNowModal.blade.php ENDPATH**/ ?>