...
@section('content')
    ...
    <div class="bd-callout bd-callout-warning m-0 m-md-4 my-4 m-md-0 ">
        <i class="fas fa-info-circle mr-2"></i> @lang('The investors will get the profit directly automatically but if you want to make a manual payment to an investor then you can pay manually from the pay manually option to the investor'). </div>
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Action')">
                                @if(($invest->how_many_times == null || $invest->how_many_times != 0) && $invest->status == 0)
                                    ...
                                    <span>
                                        <i class="fa fa-credit-card"></i> @lang(' Pay Manually')
                                    </span>
                                    </button>
                                @else
                                    ---
