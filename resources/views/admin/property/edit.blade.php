                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                ...
                                                <select name="amenity_id[]"
                                                    ...
                                                    @foreach($allAmenities as $amenity)
                                                        <option value="{{ $amenity->id }}" @if($singlePropertyDetails[$language->id][0]->manageProperty->amenity_id) {{ in_array($amenity->id, $singlePropertyDetails[$language->id][0]->manageProperty->amenity_id) ? 'selected' : '' }} @endif >@lang(optional($amenity->details)->title)</option>
                                                    @endforeach
                                                </select>
                                                @error('amenity_id')
