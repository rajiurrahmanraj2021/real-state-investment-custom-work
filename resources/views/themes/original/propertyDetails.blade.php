...
@push('seo')
    ...
    <link rel="apple-touch-icon"
          href="{{ getFile(config('location.propertyThumbnail.path').$singlePropertyDetails->thumbnail) }}">
    ...
    <meta name="apple-mobile-web-app-title"
          content="@lang($basic->site_title) | {{ optional($singlePropertyDetails->details)->property_title }}">
    <!-- Google / Search Engine Tags -->
    <meta itemprop="name"
          content="@lang($basic->site_title) | {{ optional($singlePropertyDetails->details)->property_title }}">
    <meta itemprop="description" content="{{ optional($singlePropertyDetails->details)->details }}">
    <meta itemprop="image"
          content="{{ getFile(config('location.propertyThumbnail.path').$singlePropertyDetails->thumbnail) }}">
    <!-- Facebook Meta Tags -->
                                ...
                                <div class="side-box">
                                    ...
                                    <ul class="profit-calculation">
                                        ...
                                        <li>@lang('Capital Back'):
                                            <span
                                                class="">{{ $singlePropertyDetails->is_capital_back == 1 ? 'Yes' : 'No' }}</span>
                                        </li>
                                        <hr/>
                                    </ul>
