    ...
    <ul class="main">
        ...
        <li>
            <a
                ...
                <i class="fal fa-car-building"></i>@lang('Invest')
            </a>
            <div class="collapse {{menuActive(['user.propertyMarket','user.offerList', 'user.offerConversation'],4)}} dropdownCollapsible" id="dropdownCollapsible">
                <ul class="">
                    ...
                    <li>
                        <a  class="{{($last == 'my-investment-properties') ? 'active' : '' }}" href="{{ route('user.propertyMarket', 'my-investment-properties') }}"><i class="fal fa-building"></i>@lang('My Investments')</a>
                    </li>
